...
import com.smartlink.hub.security.JwtAuthenticationFilter;
import com.smartlink.hub.security.RateLimitingFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // Add filter chain configurations
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(List.of("Authorization", "Content-Type", "X-Requested-With", "X-RateLimit-Limit", "X-RateLimit-Remaining"));
